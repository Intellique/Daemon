...
struct so_format_reader {
	struct so_format_reader_ops {
		...
		enum so_format_reader_header_status (*get_header)(struct so_format_reader * fr, struct so_format_file * file, const char * expected_path, const char * selected_path);
...
struct so_format_writer {
	struct so_format_writer_ops {
		...
		int (*close)(struct so_format_writer * fw, bool change_volume);
