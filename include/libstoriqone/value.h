 ...
 */
bool so_value_can_convert(struct so_value * val, enum so_value_type type) __attribute__((nonnull));
/**
 ...
 */
struct so_value * so_value_convert(struct so_value * val, enum so_value_type type) __attribute__((nonnull,warn_unused_result));
/**
 ...
 */
struct so_value * so_value_copy(struct so_value * val, bool deep_copy) __attribute__((nonnull,warn_unused_result));
/**
 ...
 */
bool so_value_equals(struct so_value * a, struct so_value * b) __attribute__((nonnull));
/**
 * \brief Release value
 *
 ...
 */
void so_value_free(struct so_value * value) __attribute__((nonnull));
void * so_value_get(const struct so_value * value) __attribute__((nonnull));
/**
 ...
 */
struct so_value * so_value_new_hashtable(so_value_hashtable_compupte_hash_f compute_hash) __attribute__((nonnull,warn_unused_result));
 ...
 */
struct so_value * so_value_share(struct so_value * value) __attribute__((nonnull,warn_unused_result));
int so_value_unpack(struct so_value * root, const char * format, ...) __attribute__((nonnull));
bool so_value_valid(struct so_value * value, const char * format, ...) __attribute__((nonnull));
struct so_value * so_value_vpack(const char * format, va_list params) __attribute__((nonnull(1),warn_unused_result));
int so_value_vunpack(struct so_value * root, const char * format, va_list params) __attribute__((nonnull));
bool so_value_vvalid(struct so_value * value, const char * format, va_list params) __attribute__((nonnull));

bool so_value_boolean_get(const struct so_value * value) __attribute__((nonnull));

unsigned long long so_value_custom_compute_hash(const struct so_value * value) __attribute__((nonnull));
void * so_value_custom_get(const struct so_value * value) __attribute__((nonnull));

double so_value_float_get(const struct so_value * value) __attribute__((nonnull));
 ...
 */
void so_value_hashtable_clear(struct so_value * hash) __attribute__((nonnull));
/**
 ...
 */
struct so_value * so_value_hashtable_get(struct so_value * hash, struct so_value * key, bool shared, bool detach) __attribute__((nonnull,warn_unused_result));
struct so_value * so_value_hashtable_get2(struct so_value * hash, const char * key, bool shared, bool detach) __attribute__((nonnull,warn_unused_result));
/**
 ...
 * \return an iterator
 */
struct so_value_iterator * so_value_hashtable_get_iterator(struct so_value * hash) __attribute__((nonnull,warn_unused_result));
unsigned int so_value_hashtable_get_length(struct so_value * hash) __attribute__((nonnull));
/**
 ...
 */
bool so_value_hashtable_has_key(struct so_value * hash, struct so_value * key) __attribute__((nonnull));
bool so_value_hashtable_has_key2(struct so_value * hash, const char * key) __attribute__((nonnull));
/**
 ...
 */
struct so_value * so_value_hashtable_keys(struct so_value * hash) __attribute__((nonnull));
/**
 ...
 */
void so_value_hashtable_put(struct so_value * hash, struct so_value * key, bool new_key, struct so_value * value, bool new_value) __attribute__((nonnull));
void so_value_hashtable_put2(struct so_value * hash, const char * key, struct so_value * value, bool new_value) __attribute__((nonnull));
/**
 ...
 */
void so_value_hashtable_remove(struct so_value * hash, struct so_value * key) __attribute__((nonnull));
void so_value_hashtable_remove2(struct so_value * hash, const char * key) __attribute__((nonnull));
/**
 ...
 */
struct so_value * so_value_hashtable_values(struct so_value * hash) __attribute__((nonnull));
