...
*  Last modified: Mon, 18 Nov 2013 22:43:03 +0100                            *
\****************************************************************************/
...
struct json_t * st_script_run(struct st_database_connection * connect, struct st_job * job, const char * job_type, enum st_script_type type, struct st_pool * pool, struct json_t * data);
