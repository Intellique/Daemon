...
const char * st_job_report_notif_to_string(enum st_job_record_notif notif, bool translate);
const char * st_job_status_to_string(enum st_job_status status, bool translate);
