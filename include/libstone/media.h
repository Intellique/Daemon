...
const char * st_media_format_data_type_to_string(enum st_media_format_data_type type, bool translate);
enum st_media_format_data_type st_media_string_to_format_data_type(const char * type) __attribute__((nonnull));

const char * st_media_format_mode_to_string(enum st_media_format_mode mode, bool translate);
enum st_media_format_mode st_media_string_to_format_mode(const char * mode) __attribute__((nonnull));

const char * st_media_status_to_string(enum st_media_status status, bool translate);
...
const char * st_media_type_to_string(enum st_media_type type, bool translate);

const char * st_pool_autocheck_mode_to_string(enum st_pool_autocheck_mode mode, bool translate);
...
const char * st_pool_unbreakable_level_to_string(enum st_pool_unbreakable_level level, bool translate);
