...
*  Last modified: Sun, 25 Nov 2012 15:08:49 +0100                         *
\*************************************************************************/
...
struct st_drive {
	...
	struct st_drive_ops {
		...
		struct st_format_writer * (*get_writer)(struct st_drive * drive, int file_position, struct st_stream_writer * (*filter)(struct st_stream_writer * writer));
