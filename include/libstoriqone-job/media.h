...
struct so_drive * soj_media_find_and_load_next(struct so_pool * pool, ssize_t size_needed, bool no_wait, bool * error, struct so_database_connection * db_connection);
