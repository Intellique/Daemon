...
DROP TABLE IF EXISTS ArchiveFileToMeta CASCADE;
DROP TABLE IF EXISTS ArchiveToChecksumResult CASCADE;
...
DROP TABLE IF EXISTS HomeDir CASCADE;
...
DROP TABLE IF EXISTS UsersToHomeDirToHost CASCADE;
...
DROP FUNCTION IF EXISTS unix_to_timestamp(NUMERIC);
