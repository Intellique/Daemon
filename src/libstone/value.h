...
struct st_value_v1 * st_value_new_custom_v1(void * value, st_value_free_f release) __attribute__((warn_unused_result));
...
struct st_value_iterator * st_value_hashtable_get_iterator_v1(struct st_value_v1 * hash) __attribute__((nonnull,warn_unused_result));
...
struct st_value_iterator * st_value_list_get_iterator_v1(struct st_value_v1 * list) __attribute__((nonnull,warn_unused_result));
...
struct st_value_v1 * st_value_iterator_get_key_v1(struct st_value_iterator * iter, bool move_to_next, bool shared) __attribute__((nonnull,warn_unused_result));
struct st_value_v1 * st_value_iterator_get_value_v1(struct st_value_iterator * iter, bool shared) __attribute__((nonnull,warn_unused_result));
