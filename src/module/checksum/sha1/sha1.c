...
*  Last modified: Thu, 30 Sep 2010 15:34:39 +0200                       *
\***********************************************************************/
...
static struct checksum * checksum_sha1_new_checksum(struct checksum_driver * driver, struct checksum * checksum);
...
struct checksum * checksum_sha1_new_checksum(struct checksum_driver * driver __attribute__((unused)), struct checksum * checksum) {
	if (!checksum)
